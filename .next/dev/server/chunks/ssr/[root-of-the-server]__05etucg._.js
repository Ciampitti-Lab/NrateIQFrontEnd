...
;
;
/** Absolute URLs for Open Graph / Twitter. Set `NEXT_PUBLIC_SITE_URL` on Vercel when using a custom domain. */ function getMetadataBase() {
...
const SITE_DESCRIPTION = "Crop modeling-based decision support tool for corn nitrogen fertilization across Indiana. Uses the MRTN approach to recommend economically optimal N rates based on local grain and nitrogen prices.";
...
const metadata = {
    ...
    icons: {
        icon: [
            {
                url: "/logos/NrateIQ_favicon_bw.svg",
                type: "image/svg+xml"
            }
        ],
